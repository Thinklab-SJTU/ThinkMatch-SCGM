...
# GAMGM model options
__C.GAMGM = edict()
__C.GAMGM.FEATURE_CHANNEL = 1024
__C.GAMGM.SK_ITER_NUM = 20
__C.GAMGM.SK_TAU = 0.05
__C.GAMGM.SK_EPSILON = 1e-10
__C.GAMGM.UNIV_SIZE = 10
__C.GAMGM.MAX_ITER = [200, 200]
__C.GAMGM.INIT_TAU = [0.5, 0.5]
__C.GAMGM.GAMMA = 0.5
__C.GAMGM.BETA = [1., 0.]
__C.GAMGM.CONVERGE_TOL = 1e-5
__C.GAMGM.MIN_TAU = [1e-2, 1e-2]
__C.GAMGM.SCALE_FACTOR = 1.
__C.GAMGM.QUAD_WEIGHT = 1.
__C.GAMGM.CLUSTER_QUAD_WEIGHT = 1.
__C.GAMGM.PROJECTOR = ['sinkhorn', 'sinkhorn']
